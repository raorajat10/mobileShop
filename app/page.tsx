...
export default function MobileShowroomPortfolio() {
  ...
  const services = [
    {
      ...
      title: "Device Sales",
      description: "Latest smartphones from all major brands with competitive pricing and genuine warranties.",
      color: "from-blue-500 to-cyan-500",
      features: ["Authorized dealer", "Price matching", "Genuine products", "Warranty included"],
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Extended Warranty",
      description: "Comprehensive protection plans to keep your device safe from accidents and defects.",
      color: "from-green-500 to-emerald-500",
      features: ["Accident protection", "Water damage cover", "Screen replacement", "Battery replacement"],
    },
    {
      icon: <Truck className="w-8 h-8" />,
      title: "Free Delivery",
      description: "Fast and secure delivery to your doorstep within 24 hours of purchase.",
      color: "from-purple-500 to-violet-500",
      features: ["Same day delivery", "Secure packaging", "Real-time tracking", "Contactless delivery"],
    },
    {
      icon: <CreditCard className="w-8 h-8" />,
      title: "Easy EMI Options",
      description: "Flexible payment plans with 0% interest EMI options available on all devices.",
      color: "from-orange-500 to-red-500",
      features: ["0% interest", "Flexible tenure", "Quick approval", "No hidden charges"],
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Expert Consultation",
      description: "Our tech experts help you choose the perfect device based on your needs and budget.",
      color: "from-pink-500 to-rose-500",
      features: ["Free consultation", "Personalized recommendations", "Comparison guides", "Technical support"],
    },
    {
      icon: <Headphones className="w-8 h-8" />,
      title: "24/7 Support",
      description: "Round-the-clock customer support for all your queries and technical assistance.",
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section id="home" className="relative mt-4 pt-2 pb-20 lg:mt-8 lg:pt-4 lg:pb-32 overflow-hidden">
        <div
            ...
            >
              <div className="space-y-1">
                <div className="flex items-center space-x-2 mb-4">
                  <Badge variant="secondary" className="glass-card animate-shimmer">
                ...
                <p className="max-w-[600px] text-gray-700 md:text-xl font-medium">
                  Experience the latest smartphones, cutting-edge accessories, and revolutionary tech gadgets. We offer
                  authentic products, unbeatable prices, and exceptional customer service.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                ...
                <Button variant="outline" size="lg" className="h-12 glass-card glass-card-hover group">
              ...
              <div className="flex items-center space-x-4 pt-4">
                ...
                <span className="text-sm text-gray-600 font-medium">4.9/5 from 2,500+ customers</span>
  ...
  <div className="container mx-auto px-4 text-center">
    <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 gradient-text">
      Brands We Deal With
    </h2>
    <p className="text-gray-600 mb-8 text-sm md:text-base">
      We offer the latest smartphones and accessories from top global brands.
    </p>
       ...
       <section id="services" className="py-20 relative">
        <div className="mx-auto px-6 lg:px-12 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-700 md:text-lg max-w-2xl mx-auto font-medium">
              From sales to support, we provide comprehensive mobile solutions to meet all your technology needs under
              one roof.
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <InteractiveServiceCard key={index} service={service} index={index} onLearnMore={handleLearnMoreService} />
            ))}
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                <Badge variant="secondary" className="mb-4 glass-card w-fit animate-shimmer">
                ...
                <p className="max-w-[600px] text-gray-700 md:text-lg font-medium">
                  With over 16 years of experience in the mobile industry, YashMobile has become the trusted destination
                  for smartphone enthusiasts and everyday users alike. We pride ourselMves on offering authentic
      ...
      <section id="contact" className="py-20 relative">
        <div className="mx-auto px-6 lg:px-12 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-700 md:text-lg max-w-2xl mx-auto font-medium">
              Experience our products firsthand at our premium showroom. Our expert team is ready to help you find the
              perfect device.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
                ...
                {[
                  {
                    ...
                    title: "Address",
                    content: "BadKeBalaji, Ajmer Road, Jaipur, Rajasthan 302026",
                  },
                  { icon: <Phone className="w-5 h-5 text-primary" />, title: "Phone", content: "+91 9782740000" },
                  { icon: <Mail className="w-5 h-5 text-primary" />, title: "Email", content: "info@mobilehub.com" },
                  {
                    icon: <Clock className="w-5 h-5 text-primary" />,
                    title: "Hours",
                    content: "Mon-Sun: 10AM-9PM, Last day of all months: Closed",
                  },
                ].map((item, index) => (
                  <div
                    key={index}
            ...
            <Card className="glass-card glass-card-hover">
              ...
              <CardContent>
                <div className="aspect-video glass-card rounded-lg flex items-center justify-center relative overflow-hidden cursor-pointer group">
                  ...
                  <div className="text-center relative z-10">
                    <MapPin className="w-12 h-12 text-primary mx-auto mb-2 animate-bounce group-hover:scale-110 transition-transform" />
                    <p className="text-sm text-gray-700 font-medium">Interactive Map</p>
                    <p className="text-xs text-gray-600">Click to view in Google Maps</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container px-4 md:px-6 py-8">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-600">Your trusted partner for all mobile technology needs.</p>
            </div>

            {[
              { title: "Products", items: ["Smartphones", "Accessories", "Tablets", "Smartwatches"] },
              { title: "Services", items: ["Device Setup", "Data Transfer", "Repairs", "Trade-in"] },
              { title: "Support", items: ["Contact Us", "FAQ", "Warranty", "Returns"] },
            ].map((section, index) => (
              <div key={index} className="space-y-3">
                <h4
  onClick={() => smoothScrollTo(`#${section.title.toLowerCase()}`)}
  ...
  {section.title}
          ...
          <div className="mt-8 border-t border-gray-200 pt-8 text-center text-sm text-gray-600">
            <p>
              ...
              <Heart className="w-3 h-3 inline text-red-500 animate-pulse" /> for mobile enthusiasts.
            </p>
          </div>
        </div>
      </footer>
      <ServiceDetailDrawer service={selectedService} isOpen={isServiceDrawerOpen} onClose={handleCloseServiceDrawer} />
    </div>
