            ...
            {service.features && service.features.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                {service.features.map((feature, idx) => (
                  <div
                    key={idx}
                    className="flex items-start text-gray-800 glass-card p-4 rounded-lg"
                  >
              ...
              <div className="text-center mt-10">
                <a
                  ...
                  className="inline-flex glass-card items-center gap-2 px-6 py-3 rounded-lg bg-primary text-white hover:bg-primary/90 transition-all duration-300 text-lg font-medium"
                >
